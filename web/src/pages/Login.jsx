        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-black tracking-tight text-white mb-1">
              Maxx<span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FC5F16] to-orange-400">Control</span>
            </h1>
              ...
              <div className="space-y-1 group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3 bg-[#111111]/50 border border-white/10 rounded-xl text-white placeholder-zinc-600 focus:border-[#FC5F16] focus:ring-1 focus:ring-[#FC5F16] outline-none transition-all shadow-[0_0_15px_rgba(252, 95, 22,0.1)]"
              ...
              <div className="space-y-1 group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-12 py-3 bg-[#111111]/50 border border-white/10 rounded-xl text-white placeholder-zinc-600 focus:border-[#FC5F16] focus:ring-1 focus:ring-[#FC5F16] outline-none transition-all shadow-[0_0_15px_rgba(252, 95, 22,0.1)]"
                    placeholder="••••••••"
                    required
                  />
                  <button
