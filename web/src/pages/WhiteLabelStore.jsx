...
export default function WhiteLabelStore() {
  ...
  return (
    <div className="space-y-4 animate-fadeIn">
      ...
      {/* Info Banner */}
      <div className="bg-gradient-to-r from-yellow-900/20 to-dark-800 border border-yellow-500/20 rounded-lg p-3 flex gap-3 items-start shadow-lg">
      ...
      <div className="bg-dark-800 rounded-xl border border-dark-700 shadow-xl overflow-hidden">
          ...
          <div className="p-3 space-y-4 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              {[
                ...
                <div key={plan.label} className={`bg-dark-900 rounded-lg border p-3 relative overflow-hidden transition-all hover:border-zinc-500 ${
        ...
        {activeTab === 'appearance' && (
          <div className="p-3 space-y-4 animate-fadeIn">
            ...
            <div>
              ...
              <div className="bg-dark-900 rounded-lg border border-dark-600 p-3 text-center">
                ...
                <p className="text-xs text-zinc-500 mb-3">Escolha seu plano e comece agora</p>
        ...
        {activeTab === 'payment' && (
          <div className="p-3 space-y-4 animate-fadeIn">
            ...
            <div className="bg-green-500/5 border border-green-500/20 rounded-lg p-3 flex gap-3 items-start">
        ...
        {/* Save Button */}
        <div className="p-3 border-t border-dark-700 flex justify-end gap-3">
          <button 
            onClick={handleSave}
            disabled={saving}
