...
export default function LegalDisclaimerModal() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-2">
      ...
      {/* Modal Container */}
      <div className="relative w-full max-w-2xl bg-[#0a0a0a] border border-white/10 rounded-2xl shadow-[0_0_50px_rgba(252,95,22,0.15)] overflow-hidden flex flex-col max-h-[82vh]">
        ...
        {/* Content */}
        <div className="relative z-10 p-5 md:p-2 overflow-y-auto custom-scrollbar">
          
          <div className="flex items-center gap-2 mb-2 pb-6 border-b border-white/10">
            <div className="w-9 h-9 rounded-md bg-red-500/10 flex items-center justify-center shrink-0 border border-red-500/20">
              <AlertTriangle className="text-red-500" size={24} />
            </div>
            <h2 className="text-base md:text-sm font-black text-white leading-tight">
              ATENÇÃO — O MAXX PLAYER <span className="text-red-500">NÃO VENDE NEM FORNECE</span> CONTEÚDO DE PLAYLIST!
            </h2>
          </div>

          <div className="space-y-2 text-sm md:text-base text-zinc-300 leading-relaxed">
            <p>
            ...
            <p className="font-bold text-white bg-white/5 p-2 rounded-md border border-white/10">
            ...
            <div className="flex items-start gap-2 bg-brand-500/10 p-2 rounded-md border border-brand-500/20">
            ...
            <div className="pt-6 mt-2 border-t border-white/10">
              <p className="font-bold text-white mb-2">Ao continuar, você declara estar de acordo com:</p>
        ...
        {/* Action Buttons */}
        <div className="relative z-10 bg-[#050505] p-5 border-t border-white/5 flex flex-col sm:flex-row items-center gap-2 justify-end">
          <button 
            onClick={handleDisagree}
            className="w-full sm:w-auto px-6 py-1.5 rounded-md border border-white/10 text-zinc-400 font-bold hover:bg-white/5 hover:text-white transition-colors"
          >
            Discordar
          </button>
          ...
          <button 
            onClick={handleAgree}
            className="w-full sm:w-auto px-6 py-1.5 rounded-md bg-gradient-to-r from-brand-600 to-orange-500 text-white font-black hover:from-brand-500 hover:to-orange-400 shadow-[0_0_20px_rgba(252,95,22,0.4)] transition-all active:scale-95"
          >
            Concordar
          </button>
        </div>
