...
export default function MaxxPlayerPricing() {
  ...
  return (
    <div className="bg-[#050505] min-h-screen py-16 px-4 font-sans text-white relative overflow-hidden flex flex-col items-center">
      ...
      <div className="text-center mb-12 relative z-10">
        <h4 className="text-brand-500 font-bold tracking-[0.2em] uppercase text-sm mb-4">PLANOS</h4>
      ...
      <div className="w-full max-w-5xl mx-auto flex overflow-x-auto snap-x snap-mandatory gap-6 pb-8 md:justify-center scrollbar-none relative z-10 px-4 md:px-0">
        
        {/* CARD 1: Anual */}
        <div className="snap-center shrink-0 w-[300px] md:w-[340px] bg-[#0a0a0a] border border-white/10 rounded-[2rem] p-8 flex flex-col relative transition-all duration-500 hover:border-brand-500/50 hover:shadow-[0_0_30px_rgba(252,95,22,0.1)] group">
          <div className="flex flex-col items-center border-b border-white/10 pb-8 mb-8">
            ...
            <div className="flex items-start text-brand-500 font-black leading-none group-hover:scale-105 transition-transform">
              ...
              <span className="text-7xl">49</span>
              <span className="text-3xl mt-2">,90</span>
            </div>
          ...
          <button onClick={handleActivate} className="w-full py-4 rounded-xl border border-brand-500 text-brand-500 font-bold hover:bg-brand-500 hover:text-white transition-all flex justify-center items-center gap-2 mt-auto active:scale-95">
            ASSINAR AGORA &rarr;
          </button>
        </div>

        {/* CARD 2: Vitalício (Destacado) */}
        <div className="snap-center shrink-0 w-[300px] md:w-[340px] bg-gradient-to-b from-[#150500] to-[#0a0a0a] border-2 border-brand-500 rounded-[2rem] p-8 flex flex-col relative transition-all duration-500 shadow-[0_0_40px_rgba(252,95,22,0.15)] group transform md:-translate-y-4">
          
          <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-brand-500 text-white font-black text-[10px] px-6 py-1.5 rounded-full uppercase tracking-widest shadow-[0_0_15px_rgba(252,95,22,0.5)] whitespace-nowrap">
            MAIS ESCOLHIDO
          </div>

          <div className="flex flex-col items-center border-b border-brand-500/20 pb-8 mb-8 mt-2">
            ...
            <div className="flex items-start text-brand-500 font-black leading-none group-hover:scale-105 transition-transform">
              <span className="text-2xl mt-2 mr-1">R$</span>
              <span className="text-7xl">199</span>
              <span className="text-3xl mt-2">,00</span>
            </div>
          ...
          <button onClick={handleActivate} className="w-full py-4 rounded-xl bg-gradient-to-r from-brand-600 to-orange-500 text-white font-black hover:from-brand-500 hover:to-orange-400 shadow-[0_0_20px_rgba(252,95,22,0.4)] transition-all flex justify-center items-center gap-2 mt-auto active:scale-95">
            ASSINAR AGORA &rarr;
          </button>
        </div>
      ...
      {/* Trust Badges */}
      <div className="w-full max-w-5xl mx-auto mt-8 border border-white/5 bg-white/[0.02] rounded-2xl p-6 md:p-8 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-4 relative z-10">
      ...
      <div className="w-full max-w-5xl mx-auto mt-16 bg-gradient-to-r from-brand-900/30 to-black border border-brand-500/20 rounded-3xl p-8 relative flex flex-col md:flex-row items-center justify-between gap-8 z-10 overflow-visible">
        ...
        <div className="md:ml-56 flex flex-col md:flex-row items-center justify-between w-full gap-8">
           <div className="text-center md:text-left">
             <h4 className="text-white font-bold text-lg md:text-xl">AINDA COM DÚVIDAS?</h4>
             <h3 className="text-brand-500 font-black text-2xl md:text-3xl">TESTE GRÁTIS POR 24 HORAS!</h3>
           </div>
           ...
           <button onClick={() => window.open('https://wa.me/5511999999999', '_blank')} className="bg-gradient-to-b from-brand-500 to-brand-700 hover:from-brand-400 hover:to-brand-600 active:scale-95 transition-all px-8 py-4 rounded-xl text-white font-black shadow-[0_0_20px_rgba(252,95,22,0.5)] flex items-center gap-3">
