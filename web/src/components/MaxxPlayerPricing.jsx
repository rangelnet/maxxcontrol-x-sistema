...
export default function MaxxPlayerPricing() {
  ...
  return (
    <div className="bg-[#050505] min-h-screen py-8 px-4 font-sans text-white relative overflow-hidden flex flex-col items-center">
      ...
      <div className="w-full max-w-5xl mx-auto flex overflow-x-auto snap-x snap-mandatory gap-6 pb-6 md:justify-center scrollbar-none relative z-10 px-4 md:px-0">
        
        {/* CARD 1: Anual */}
        <div className="snap-center shrink-0 w-[300px] md:w-[340px] bg-[#0a0a0a] border border-white/10 rounded-[2rem] p-6 flex flex-col relative transition-all duration-500 hover:border-brand-500/50 hover:shadow-[0_0_30px_rgba(252,95,22,0.1)] group">
          ...
          <button onClick={handleActivate} className="w-full py-4 rounded-lg border border-brand-500 text-brand-500 font-bold hover:bg-brand-500 hover:text-white transition-all flex justify-center items-center gap-2 mt-auto active:scale-95">
            ASSINAR AGORA &rarr;
          </button>
        </div>

        {/* CARD 2: Vitalício (Destacado) */}
        <div className="snap-center shrink-0 w-[300px] md:w-[340px] bg-gradient-to-b from-[#150500] to-[#0a0a0a] border-2 border-brand-500 rounded-[2rem] p-6 flex flex-col relative transition-all duration-500 shadow-[0_0_40px_rgba(252,95,22,0.15)] group transform md:-translate-y-4">
          ...
          <button onClick={handleActivate} className="w-full py-4 rounded-lg bg-gradient-to-r from-brand-600 to-orange-500 text-white font-black hover:from-brand-500 hover:to-orange-400 shadow-[0_0_20px_rgba(252,95,22,0.4)] transition-all flex justify-center items-center gap-2 mt-auto active:scale-95">
            ASSINAR AGORA &rarr;
          </button>
        </div>
      ...
      {/* Trust Badges */}
      <div className="w-full max-w-5xl mx-auto mt-6 border border-white/5 bg-white/[0.02] rounded-xl p-5 md:p-6 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-4 relative z-10">
      ...
      <div className="w-full max-w-5xl mx-auto mt-16 bg-gradient-to-r from-brand-900/30 to-black border border-brand-500/20 rounded-3xl p-6 relative flex flex-col md:flex-row items-center justify-between gap-6 z-10 overflow-visible">
        ...
        <div className="md:ml-56 flex flex-col md:flex-row items-center justify-between w-full gap-6">
           ...
           <button onClick={() => window.open('https://wa.me/5511999999999', '_blank')} className="bg-gradient-to-b from-brand-500 to-brand-700 hover:from-brand-400 hover:to-brand-600 active:scale-95 transition-all px-6 py-4 rounded-lg text-white font-black shadow-[0_0_20px_rgba(252,95,22,0.5)] flex items-center gap-3">
