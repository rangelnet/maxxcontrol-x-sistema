-- Migration: Criar tabela banners
-- Data: 2025-01-XX
...
COMMENT ON COLUMN banners.type IS 'Tipo do banner (filme, série, etc)';
COMMENT ON COLUMN banners.title IS 'Título do conteúdo';
COMMENT ON COLUMN banners.data IS 'Dados do conteúdo em formato JSON';
COMMENT ON COLUMN banners.template IS 'Template usado para gerar o banner';
COMMENT ON COLUMN banners.image_url IS 'URL da imagem do banner gerado';
