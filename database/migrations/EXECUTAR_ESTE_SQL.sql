-- ============================================
-- POPULAR CONTEÚDOS - EXECUTE NO SUPABASE
-- ============================================
-- Copie e cole este código no Supabase SQL Editor
-- https://supabase.com/dashboard → Projeto mmfbirjrhrhobbnzfffe → SQL Editor
...
-- 2. Inserir 20 conteúdos populares (10 filmes + 10 séries)
...
-- ============================================
-- PRONTO! Você deve ter 20 conteúdos agora!
-- Acesse: https://maxxcontrol-frontend.onrender.com/banners
-- ============================================
